...
class PolygonDetection:
    ...
    def intersection_over_union(self, another_polygon_detection: 'PolygonDetection'):
        assert isinstance(another_polygon_detection, PolygonDetection)
        return self.polygon.intersection_over_union(another_polygon_detection.polygon)
